    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/3 glass p-4 rounded-xl shadow-md flex flex-col">
          ...
          {omdbInfo && (
            <div className="mt-4 text-xs text-neutral-300 border-t border-white/10 pt-3">
              ...
              <p>
                Durée : {omdbInfo.runtime || "N/A"}{omdbInfo.imdbRating && <> • Note IMDb : {omdbInfo.imdbRating}/10</>}
              </p>
            </div>
          )}

          {/* Bouton Proposer une fin responsive */}
        ...
        <section className="flex-1 flex flex-col gap-4">
          ...
          {voteError && <p className="text-sm text-red-400 mb-2">{voteError}</p>}
